...
frame1.place(x=0,y=55,width=1335,height=550)

lf1 = LabelFrame(frame1,text='No. of Patients in hospital having same blood type',font='ariel 20 bold',bd=10,bg='pink')
lf1.place(x=8,y=0,width=1300,height=500)

#Label(lf1,text='doctor_id',font='ariel 15',bg='pink').place(x=5,y=50)

frame2 = Frame(win,bd=15,relief=RIDGE)
frame2.place(x=0,y=200,width=1335,height=440)
...
e_btn.place(x=510,y=641,width=270)
